...
# generate_data_mixture, regpanelmixmixturePMLE, NonParTestNoCovariates, LRTestNoCovariates, LRTestMixture
...
def parallel_processing(nrep, M_max, BB, alpha, mu, sigma, tau, N, T, M, K, p, q):
    ...
    for ii in prange(nrep):  # Use prange for parallel execution
        ...
        for mm in range(M_max):
            ...
            lr_results_nocov = LRTestNoCovariates(y, x, z, p, q, m, N, T, bootstrap=bootstrap_nocov, BB=BB)
