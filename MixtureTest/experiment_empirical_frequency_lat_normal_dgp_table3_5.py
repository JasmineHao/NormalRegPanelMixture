...
if __name__ == "__main__":
    ...
    Data = [generate_data_ar1_noconstraint(alpha,  mu, sigma, beta, gamma, mu_0, sigma_0, beta_0, gamma_0, N, T, M, p, q) for _ in prange(nrep)]
    ...
    # Save to CSV
    result_freq_table.to_csv("test_empirical_dgp_lat_normal.csv")
