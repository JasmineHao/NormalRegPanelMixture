...
python -u empirical_test.py kmshare_mixture_4 3  ciiu mY_share > output_empirical_kmshare_mixture_4_ciiu.log 2>&1 &

python -u empirical_test.py ar1_kmshare 3  ciiu mY_share > output_empirical_ar1_kmshare.log 2>&1 &
python -u empirical_test.py ar1_kmshare_mixture 3  ciiu mY_share > output_empirical_ar1_kmshare_mixture.log 2>&1 & 
python -u empirical_test.py ar1_kmshare_mixture_3 3  ciiu mY_share > output_empirical_ar1_kmshare_mixture_3.log 2>&1 & 
