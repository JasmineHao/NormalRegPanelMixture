...
muset 		<- list(c(-4, 0, 4), c(-4, 0, 6), c(-6, 0, 6))
sigmaset <- list(c(0.75, 1.5, 0.75))
...
write.csv(result.h, file = "/home/haoyu/SizeTest/results/sizeTestM3SimH_1.csv")
write.csv(result.m, file = "/home/haoyu/SizeTest/results/sizeTestM3SimM_1.csv")
write.csv(result.l, file = "/home/haoyu/SizeTest/results/sizeTestM3SimL_1.csv")
