...
write.csv(df.2,file="results/Empirical/Japan_resultLR2_regressor_beta_ratio_normed.csv")
write.csv(df.3,file="results/Empirical/Japan_resultLR3_regressor_beta_ratio_normed.csv")
write.csv(df.4,file="results/Empirical/Japan_resultLR4_regressor_beta_ratio_normed.csv")
write.csv(df.5,file="results/Empirical/Japan_resultLR5_regressor_beta_ratio_normed.csv")
