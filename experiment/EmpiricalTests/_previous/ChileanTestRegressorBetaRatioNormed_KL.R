...
write.csv(df.2,file="results/Empirical/Chile_resultLR2_beta_ratio_normed_kl.csv")
write.csv(df.3,file="results/Empirical/Chile_resultLR3_beta_ratio_normed_kl.csv")
write.csv(df.4,file="results/Empirical/Chile_resultLR4_beta_ratio_normed_kl.csv")
write.csv(df.5,file="results/Empirical/Chile_resultLR5_beta_ratio_normed_kl.csv")
