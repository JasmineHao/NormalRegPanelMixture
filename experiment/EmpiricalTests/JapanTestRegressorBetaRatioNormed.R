...
write.csv(df.2,file="results/Japan/resultLR2_regressor_beta_ratio_normed.csv")
write.csv(df.3,file="results/Japan/resultLR3_regressor_beta_ratio_normed.csv")
write.csv(df.4,file="results/Japan/resultLR4_regressor_beta_ratio_normed.csv")
write.csv(df.5,file="results/Japan/resultLR5_regressor_beta_ratio_normed.csv")
